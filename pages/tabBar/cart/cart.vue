	...
	export default {
		data() {
			return {
				...
				isAllselected:false,
				goodsList:[
					// {id:1,img:'/static/img/goods/p1.jpg',name:'小米MAX',spec:'规格:标配',price:127.5,number:1,selected:false},
					// {id:2,img:'/static/img/goods/p2.jpg',name:'华为P30',spec:'规格:裸机',price:1234,number:1,selected:false},
					// {id:3,img:'/static/img/goods/p3.jpg',name:'魅族',spec:'规格:套餐一',price:3444,number:1,selected:false},
					// {id:4,img:'/static/img/goods/p4.jpg',name:'锤子',spec:'规格:要啥给啥',price:9000,number:1,selected:false},
					// {id:5,img:'/static/img/goods/p1.jpg',name:'OPPO',spec:'规格:有啥给啥',price:12712.5,number:1,selected:false}
				],
				//控制滑动效果
				theIndex:null,
				oldIndex:null,
