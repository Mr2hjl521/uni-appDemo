	...
	export default {
		...
		methods:{
			getMsgList(){
				// 消息列表
				let list = [
					{id:0,uid:0,username:"叮当猫",face:"/static/img/face.jpg",time:"12:56",type:"text",msg:{content:"能便宜点吗？"}},
					{id:1,uid:1,username:"售后客服008",face:"/static/img/im/face/face_2.jpg",time:"12:57",type:"text",msg:{content:"亲亲，这个已经是打折产品了，你可以去看看有没有优惠活动哦。"}},
					...
					{id:3,uid:0,username:"叮当猫",face:"/static/img/face.jpg",time:"13:05",type:"voice",msg:{url:"/static/voice/2.mp3",length:"00:06"}},
					{id:4,uid:0,username:"叮当猫",face:"/static/img/face.jpg",time:"13:05",type:"img",msg:{url:"/static/img/goods/p10.jpg",w:200,h:200}},
