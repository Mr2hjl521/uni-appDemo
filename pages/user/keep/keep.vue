...
<script>
	...
	export default {
		data() {
			return {
				goodsList:[
					{id:1,img:'/static/img/goods/p1.jpg',name:'啦啦啦啦',spec:'规格:标准套餐',price:127.5,number:1,selected:false},
					{id:2,img:'/static/img/goods/p1.jpg',name:'哈哈哈哈',spec:'规格:豪华套餐',price:127.5,number:1,selected:false},
					{id:3,img:'/static/img/goods/p1.jpg',name:'略略略略',spec:'规格:以旧换新',price:127.5,number:1,selected:false},
				],
				shopList:[
					{id:1,name:"二手手机",img:"/static/img/shop/1.jpg"},
					{id:2,name:"手机贴膜",img:"/static/img/shop/2.jpg"},
					{id:3,name:"手机回收",img:"/static/img/shop/3.jpg"},
					{id:4,name:"新机查看",img:"/static/img/shop/4.jpg"}
				],
				headerTop:0,
				//控制滑动效果
				typeClass:'goods',
