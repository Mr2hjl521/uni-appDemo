		...
		<view class="goods-list">
			<view class="product-list">
				<view class="product" v-for="goods in goodsList" :key="goods.id" @tap="toGoods(goods)">
					<image mode="widthFix" :src="goods.filmImage"></image>
					<view class="name">{{ goods.filmName }}</view>
					<view class="info">
						<view class="price">&yen; {{ goods.filmPrice }} .00</view>
						<view class="slogan">库存{{ goods.filmStock }}</view>
					</view>
				</view>
			</view>
...
export default {
	data() {
		return {
			goodsList: [
// 				{ id: 0, filmImage: '/static/img/screen/g3.jpg', filmName: '商品名称', filmPrice: '￥168', filmStock: '1235人付款' },
// 				{ id: 1, filmImage: '/static/img/screen/g5.jpg', filmName: '商品名称', filmPrice: '￥168', filmStock: '1235人付款' },
// 				{ id: 2, filmImage: '/static/img/screen/g4.jpg', filmName: '商品名称', filmPrice: '￥168', filmStock: '1235人付款' },
// 				{ id: 4, filmImage: '/static/img/screen/g6.jpg', filmName: '商品名称', filmPrice: '￥168', filmStock: '1235人付款' },
// 				{ id: 5, filmImage: '/static/img/screen/g10.jpg', filmName: '商品名称', filmPrice: '￥168', filmStock: '1235人付款' },
// 				{ id: 6, filmImage: '/static/img/screen/s1.jpg', filmName: '商品名称', filmPrice: '￥168', filmStock: '1235人付款' }
			],
			loadingText: '我也是有底线的！',
			headerTop: '0px',
	...
	onLoad: function(option) {
		//option为object类型，会序列化上个页面传递的参数
		 //("上个页面传过来的系列id",option.cid); //打印出上个页面传递的参数。
		...
		// 获取一个系列的所有手机膜
		this.Get('http://39.99.137.77:8081/projects/phoneFilm/findPhoneFilmBySeriesId', { seriesId: option.cid }, data => {
			 //(data);
			var res=this
			res.goodsList=data.list;
			 //("=======",res.goodsList)
