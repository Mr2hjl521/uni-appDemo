...
export default {
	data() {
		return {
			...
			//轮播主图数据
			swiperList: [
				{ id: 1, img: 'http://img0.imgtn.bdimg.com/it/u=2750647803,1855444243&fm=11&gp=0.jpg' },
				{ id: 2, img: 'http://img0.imgtn.bdimg.com/it/u=268675669,370417397&fm=26&gp=0.jpg' },
				{ id: 3, img: 'http://img5.imgtn.bdimg.com/it/u=3705535377,63162554&fm=26&gp=0.jpg' },
				{ id: 4, img: 'http://img3.imgtn.bdimg.com/it/u=3336237833,1050223670&fm=15&gp=0.jpg' }
			],
			//轮播图下标
			currentSwiper: 0,
			anchorlist:[],//导航条锚点
			...
			goodsData:{
				...
				comment:{
					...
					username:'叮当猫',
					content:'很不错，之前买的，很好看，和图片色差不大，值得购买！'
				}
			},
			selectSpec:null,//选中规格
			isKeep:false,//收藏
			//商品描述html
			descriptionStr:'<div style="text-align:center;"><img width="100%" src="http://img0.imgtn.bdimg.com/it/u=2750647803,1855444243&fm=11&gp=0.jpg"/><img width="100%" src="http://img0.imgtn.bdimg.com/it/u=268675669,370417397&fm=26&gp=0.jpg"/><img width="100%" src="http://img5.imgtn.bdimg.com/it/u=3705535377,63162554&fm=26&gp=0.jpg"/></div>'
		};
	},
	onLoad(option) {
		// #ifdef MP
